  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        // Format dates
        if (fetchedData.prescriptionDate) {
          fetchedData.prescriptionDate =
            fetchedData.prescriptionDate.split("T")[0];
        }
        if (fetchedData.nextVisitDate) {
          fetchedData.nextVisitDate = fetchedData.nextVisitDate.split("T")[0];
        }
